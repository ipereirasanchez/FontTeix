...
const translations = {
  es: {
    ...
    "about.imgAlt": "Camión de reparto frente a las instalaciones de Font Teix S.A. en Bunyola",
    ...
    "hero.eyebrow": "Bunyola, Mallorca",
    "hero.title": "Font Teix S.A.",
    "hero.subtitle": "Política de Calidad,<br>Seguridad&nbsp;Alimentaria<br>y Medio Ambiente",
    ...
    "p4.body": "Nos comprometemos a comprender y satisfacer las necesidades y expectativas de nuestros clientes, garantizando productos seguros y de calidad.",
    ...
    "instalaciones.body2": "Nuestra planta cuenta con la certificación IFS Food, que acompaña cada uno de los principios recogidos en esta política y garantiza que el agua llega al consumidor con la misma calidad e integridad que tiene en su punto de surgencia.",
    "producto.imgAlt": "Botellas de agua mineral natural Font des Teix",
    "producto.eyebrow": "Nuestro compromiso",
    "producto.title": "Un agua de calidad",
  ...
  ca: {
    ...
    "about.imgAlt": "Camió de repartiment davant les instal·lacions de Font Teix S.A. a Bunyola",
    ...
    "hero.eyebrow": "Bunyola, Mallorca",
    "hero.title": "Font Teix S.A.",
    "hero.subtitle": "Política de Qualitat,<br>Seguretat&nbsp;Alimentària<br>i Medi Ambient",
    ...
    "p4.body": "Ens comprometem a comprendre i satisfer les necessitats i expectatives dels nostres clients, garantint productes segurs i de qualitat.",
    ...
    "instalaciones.body2": "La nostra planta compta amb la certificació IFS Food, que acompanya cadascun dels principis recollits en aquesta política i garanteix que l'aigua arriba al consumidor amb la mateixa qualitat i integritat que té al seu punt de sorgència.",
    "producto.imgAlt": "Ampolles d'aigua mineral natural Font des Teix",
    "producto.eyebrow": "El nostre compromís",
    "producto.title": "Una aigua de qualitat",
